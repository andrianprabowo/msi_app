...
class ItemBinRfo with ChangeNotifier {
  ...
  @override
  String toString() {
    return 'ItemBinRfo(itemCode: $itemCode, itemName: $itemName, binCode: $binCode, fgBatch: $fgBatch, binCodeDestination: $binCodeDestination, availableQty: $availableQty, remainingQty: $remainingQty, putQty: $putQty, batchList: $batchList)';
  }
}
