...
class ListPickListDetail with ChangeNotifier {
  final String doNo;
  final String doNo1;
  String grpodlvNo;
  ...
  factory ListPickListDetail.fromMap(Map<String, dynamic> map) {
    if (map == null) return null;

    return ListPickListDetail(
      doNo: map['doNo'] ?? '',
      doNo1: map['doNo1'] ?? '',
