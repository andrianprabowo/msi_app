...
class ListInvDispatchDetail with ChangeNotifier {
  final String doNo;
  final String doNo1;
   String soidpNo;
  ...
  factory ListInvDispatchDetail.fromMap(Map<String, dynamic> map) {
    if (map == null) return null;

    return ListInvDispatchDetail(
      doNo: map['doNo'] ?? '',
      doNo1: map['doNo1'] ?? '',
      soidpNo: map['soidpNo'] ?? '',
  ...
  factory ListInvDispatchDetail.fromJson(String source) =>
      ListInvDispatchDetail.fromMap(json.decode(source));

  @override
  String toString() {
    return 'ListInvDispatchDetail(doNo: $doNo, soidpNo: $soidpNo, kdVendor: $kdVendor, nmVendor: $nmVendor, plant: $plant, storageLocation: $storageLocation, storageLocationName: $storageLocationName, itemGroupCode: $itemGroupCode, fileName: $fileName, docNum: $docNum, remark: $remark, soidpNo1: $soidpNo1, idGrpodlvHeader: $idGrpodlvHeader, status: $status, idUserInput: $idUserInput, idUserApproved: $idUserApproved, back: $back, postingDate: $postingDate, deliveryDate: $deliveryDate, lastmodified: $lastmodified)';
  }
}
