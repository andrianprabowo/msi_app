...
class ListStckCountDetailProvider with ChangeNotifier {
  List<ListStckCountDetail> _items = [];
  ListStckCountDetail _selected;

  List<ListStckCountDetail> get items => _items;
  ListStckCountDetail get selected => _selected;

  Future<void> getAllData(int idGrpodlvHeader) async {
    final url = '$kBaseUrl/tgrpo/tgrpo/api/stckcnting/$idGrpodlvHeader';
    ...
    try {
     ...
     // print("data gajelas $_selected");
      ...
      final List<ListStckCountDetail> list = [];
      data.forEach((map) {
        list.add(ListStckCountDetail.fromMap(map));
      });
  ...
  void selectPo(ListStckCountDetail purchaseOrder) {
