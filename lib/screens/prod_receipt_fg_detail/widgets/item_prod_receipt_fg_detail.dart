...
class ItemProdReceiptFgDetail extends StatelessWidget {
  final ListProdReceiptFgDetail itemDetail;

  const ItemProdReceiptFgDetail(this.itemDetail);

  void postData(BuildContext context, ProductionReceiptAllTransactionModel item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider = Provider.of<ListProdReceiptFgDetailProvider>(context, listen: false);
              ...
              // try {
              await provider.cancelDocument(item.idGrpofgHeader);
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine(
                      'ID Grpo FG Header', itemDetail.idGrpofgHeader.toString()),
