...
class ExpiredDialogReceipt extends StatefulWidget {
  final ItemBatchRfo item;

  const ExpiredDialogReceipt(this.item);

  @override
  _ExpiredDialogReceiptState createState() =>
      _ExpiredDialogReceiptState();
}

class _ExpiredDialogReceiptState
    extends State<ExpiredDialogReceipt> {
