...
class ItemListPickListSo extends StatelessWidget {
  final ListPickListSoo item;

  const ItemListPickListSo(this.item);
      ...
      onTap: () {
        if (item.status == 0) {
          ...
          Navigator.of(context)
              .pushNamed(ListPickListSoDetailScreen.routeName, arguments: item);
        }
      },
      child: Container(
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine(
                      'Pick List Sap No ', item.picklistSapnumber.toString()),
