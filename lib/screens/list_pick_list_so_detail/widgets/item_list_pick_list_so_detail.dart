...
class ItemListPickListSoDetail extends StatelessWidget {
  final ListPickListSooDetail itemDetail;

  const ItemListPickListSoDetail(this.itemDetail);

  void postData(BuildContext context, ListPickListSoo item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider = Provider.of<ListPickListSooDetailProvider>(context, listen: false);
              ...
              // try {
              final response = await provider.cancelDocument(item.idSoplHeader);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        final detail =
            Provider.of<ListPickListSoProvider>(context, listen: false)
                .selected;
