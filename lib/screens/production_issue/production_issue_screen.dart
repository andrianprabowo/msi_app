...
import 'package:msi_app/screens/production_issue/widgets/production_issue_bin_lis.dart';
...
class ProductionIssue extends StatelessWidget {
  static const routeName = '/production_issue';

  Future<void> refreshData(BuildContext context) async {
    await Provider.of<ProductionIssueProvider>(context, listen: false).getBinLoc();
  }
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .pushNamed(ProductionIssueAllTransaction.routeName);
            },
          ),
          IconButton(
      ...
      child: FutureBuilder(
        ...
        builder: (_, snapshot) {
          ...
          return RefreshIndicator(
            ...
            child: Consumer<ProductionIssueProvider>(
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (_, index) {
                        return ChangeNotifierProvider.value(
                          ...
                          child: ProductionIssueBinList(provider.items[index]),
                        );
                      },
                    ),
            ),
