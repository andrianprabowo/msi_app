...
import 'package:msi_app/models/list_pick_list_prod_receipt_detail.dart';
...
class ProdItemListPickListDetailReceipt extends StatelessWidget {
  final ListPickListProdReceiptDetail itemDetail;

  const ProdItemListPickListDetailReceipt(this.itemDetail);

  void postData(BuildContext context, ProductionReceiptRMAllTransactionModel item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider = Provider.of<ListPickListProdReceiptDetailProvider>(context, listen: false);
              ...
              // try {
              await provider.cancelDocument(item.idPutAwyProdHeader);
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine(
                      'ID Plrm Header', itemDetail.idPutAwyProdHeader.toString()),
