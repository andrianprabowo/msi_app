...
class ItemListInvDispatchRtvDetail extends StatelessWidget {
  final ListInvDispatchRtvDetail itemDetail;

  const ItemListInvDispatchRtvDetail(this.itemDetail);

  void postData(BuildContext context, ListInvDispatchRtv item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider =
                  Provider.of<ListInvDispatchRtvDetailProvider>(context, listen: false);
              ...
              // try {
              await provider.cancelDocument(item.idRvidpHeader);
        ...
        return AlertDialog(
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: getProportionateScreenHeight(kLarge)),
              Text('Inventory Dispatch Return To Vendor'),
              SizedBox(height: getProportionateScreenHeight(kLarge)),
              SizedBox(height: getProportionateScreenHeight(kLarge)),
              SizedBox(
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine(
                      'Dispatch Return to Vendor ID', itemDetail.idRvidpHeader.toString()),
