...
class ItemListPickListDetail extends StatelessWidget {
  final ListPickListDetail itemDetail;

  const ItemListPickListDetail(this.itemDetail);

  void postData(BuildContext context, ListPickList item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider =
                  Provider.of<ListPickListDetailProvider>(context, listen: false);
        ...
        return AlertDialog(
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: getProportionateScreenHeight(kLarge)),
              Text('Pick List Transfer To Outlet'),
              SizedBox(height: getProportionateScreenHeight(kLarge)),
              SizedBox(height: getProportionateScreenHeight(kLarge)),
              SizedBox(
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine(
                      'PickList Transfer to Outlet ID', itemDetail.idGrpodlvHeader.toString()),
