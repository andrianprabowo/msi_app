...
import 'package:msi_app/models/list_inv_dispatch_detail.dart';
...
class ItemListInvDispatchDetail extends StatelessWidget {
  final ListInvDispatchDetail itemDetail;

  const ItemListInvDispatchDetail(this.itemDetail);

  void postData(BuildContext context, ListInvDispatch item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider =
                  Provider.of<ListInvDispatchDetailProvider>(context, listen: false);
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushNamedAndRemoveUntil(
                        InventoryDispatchHeaderScreen.routeName, (route) => false);
                  },
                ),
              ),
            ],
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine(
                      'Dispatch Transfer to Outlet ID', itemDetail.idGrpodlvHeader.toString()),
