...
class InventoryDispatchBatchWidgetSo extends StatelessWidget {
  final InventoryDispatchItemSo pickItem;
  final InventoryDispatchBatchSo batch;

  const InventoryDispatchBatchWidgetSo(this.pickItem, this.batch);
