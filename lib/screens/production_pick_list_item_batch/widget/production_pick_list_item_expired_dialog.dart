...
class ProductionPickListItemExpired extends StatefulWidget {
  final ProductionPickListItemBatchModel item;

  const ProductionPickListItemExpired(this.item);

  @override
  _ProductionPickListItemExpiredState createState() =>
      _ProductionPickListItemExpiredState();
}

class _ProductionPickListItemExpiredState
    extends State<ProductionPickListItemExpired> {
