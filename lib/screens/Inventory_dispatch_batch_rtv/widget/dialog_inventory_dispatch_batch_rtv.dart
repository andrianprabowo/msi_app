...
class DialogInventoryDispatchBatchRtv extends StatefulWidget {
  final InventoryDispatchBatchRtv item;

  const DialogInventoryDispatchBatchRtv(this.item);

  @override
  _DialogInventoryDispatchBatchRtvState createState() => _DialogInventoryDispatchBatchRtvState();
}

class _DialogInventoryDispatchBatchRtvState extends State<DialogInventoryDispatchBatchRtv> {
