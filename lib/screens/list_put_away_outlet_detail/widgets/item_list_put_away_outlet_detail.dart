...
class ItemListPutAwayOutletDetail extends StatelessWidget {
  final ListPutAwayRfoDetail itemDetail;

  const ItemListPutAwayOutletDetail(this.itemDetail);

  void postData(BuildContext context, ListPutAwayRfo item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              // try {
              await provider.cancelDocument(item.idPwyrtoHeader);
