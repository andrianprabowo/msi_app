...
class ProdItemListPickListDetail extends StatelessWidget {
  ...
  void postData(
      BuildContext context, ProductionPickListAllTransactionModel item) {
    showDialog(
      context: context,
      child: AlertDialog(
        ...
        actions: [
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              final provider = Provider.of<ListPickListProdDetailProvider>(
                  context,
                  listen: false);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        final detail = Provider.of<ProductionPickListAllTransactionProvider>(
                context,
                listen: false)
            .selected;
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  BaseTextLine('Pick List Trf Inter Sentul ID',
                      itemDetail.idPlrmHeader.toString()),
