...
import 'package:msi_app/widgets/item_bin_picklist.dart';
import 'package:msi_app/widgets/item_date_picklist.dart';
...
class PickCheckScreen extends StatelessWidget {
  ...
  Widget buildItemDetails(List<PickItemReceive> list) {
    return Expanded(
      child: ListView.builder(
        itemCount: list.length,
        itemBuilder: (_, i) {
          return PickDetailCheck(list[i]);
        },
      ),
    );
  }
