...
class ItemDateProdReceipt extends StatefulWidget {
  @override
  _ItemDateProdReceiptState createState() => _ItemDateProdReceiptState();
}

class _ItemDateProdReceiptState extends State<ItemDateProdReceipt> {
  DateTime _selectedDate = DateTime.now();

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<ProductionReceiptRMNumberListProvider>(context, listen: false);
