...
class ItemDateDispatchSo extends StatefulWidget {
  @override
  _ItemDateDispatchSoState createState() => _ItemDateDispatchSoState();
}

class _ItemDateDispatchSoState extends State<ItemDateDispatchSo> {
  DateTime _selectedDate = DateTime.now();

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<InventoryDispatchDetailSoProvider>(context, listen: false);
