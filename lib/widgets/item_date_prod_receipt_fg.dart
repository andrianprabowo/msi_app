...
class ItemDateProdReceiptFg extends StatefulWidget {
  @override
  _ItemDateProdReceiptFgState createState() => _ItemDateProdReceiptFgState();
}

class _ItemDateProdReceiptFgState extends State<ItemDateProdReceiptFg> {
