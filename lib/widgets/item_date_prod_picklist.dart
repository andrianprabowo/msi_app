...
class ItemDateProdPickList extends StatefulWidget {
  @override
  _ItemDateProdPickListState createState() => _ItemDateProdPickListState();
}

class _ItemDateProdPickListState extends State<ItemDateProdPickList> {
