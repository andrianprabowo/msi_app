...
class ItemDateReceiptOutlet extends StatefulWidget {
  @override
  _ItemDateReceiptOutletState createState() => _ItemDateReceiptOutletState();
}

class _ItemDateReceiptOutletState extends State<ItemDateReceiptOutlet> {
