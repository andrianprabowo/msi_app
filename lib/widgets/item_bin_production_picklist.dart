...
class ItemBinProductionPickList extends StatelessWidget {
  @override
  ...
  Widget buildChangeBin(BuildContext context) {
    final binProvider = Provider.of<BinProductionPickListProvider>(context, listen: false);
    final authProvider = Provider.of<AuthProvider>(context, listen: false);
    final poProvider = Provider.of<ProductionPickListProvider>(context, listen: false);
    return IconButton(
