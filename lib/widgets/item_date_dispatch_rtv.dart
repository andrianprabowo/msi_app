...
class ItemDateDispatchRtv extends StatefulWidget {
  @override
  _ItemDateDispatchRtvState createState() => _ItemDateDispatchRtvState();
}

class _ItemDateDispatchRtvState extends State<ItemDateDispatchRtv> {
  DateTime _selectedDate = DateTime.now();

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<InventoryDispatchDetailRtvProvider>(context, listen: false);
